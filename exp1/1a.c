...
void print_to_terminal(const char *function_names[], double values[][101], int num_functions, int size);

void write_to_csv(const char *filename, const char *function_names[], double values[][101], int num_functions, int size);
...
double natural_log(int n)
{
    return (n > 0) ? log(n) : NAN;
}

double log_base2(int n)
{
    return (n > 0) ? log2(n) : NAN;
}
...
double ln_of_ln(int n)
{
    return (n > 1) ? log(log(n)) : NAN;
}

double lg_of_lg(int n)
{
    return (n > 1) ? log2(log2(n)) : NAN;
}

double n_log2(int n)
{
    return (n > 0) ? n * log2(n) : 0;
}

long long n_power_of_two(int n)
{
    return (long long)n * (long long)pow(2, n);
}
